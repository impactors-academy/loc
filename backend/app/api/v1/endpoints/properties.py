...
@router.post("/", response_model=PropertyRead, status_code=201, dependencies=[Depends(require_editor_key)])
...
@router.put("/{slug}", response_model=PropertyRead, dependencies=[Depends(require_editor_key)])
