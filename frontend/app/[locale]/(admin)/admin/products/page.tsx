  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="font-heading text-2xl font-semibold text-loc-night">Products</h1>
          <p className="text-loc-stone text-sm mt-0.5">{items.length} total</p>
        </div>
        <Link href="/admin/products/new" className="px-4 py-2 bg-loc-terracotta text-white text-sm font-semibold rounded-lg hover:bg-loc-terracotta/90 transition-colors">
          + New product
        </Link>
      </div>
