...
export default function DashboardPage() {
  ...
  return (
    <div className="p-8">
      <h1 className="font-heading text-2xl font-semibold text-loc-night mb-1">Overview</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {CARDS.map((card, i) => (
          ...
          >
            <p className="text-3xl font-heading font-semibold text-loc-terracotta mb-1">
              {counts[i] ?? "—"}
            </p>
